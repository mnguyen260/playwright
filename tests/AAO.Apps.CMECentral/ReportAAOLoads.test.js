...
test('test @regression', async ({ page, baseURL }) => {
  ...
  // Click text=Report AAO Credits
  await page.click('text=Report AAO Credits');
  expect(page.url()).toBe('https://secure-dev.aao.org/aao/cme-central#/reportAAOCredits');
